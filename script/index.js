const powrBtn = document.querySelector("#power-btn");
...
const computerChoiceE1 = document.querySelector(".computer-choice");
...
function playRound(playerSelection) {
    if (!isAnimating && !isGameEnding) {
        ...
        computerChoiceE1.src=`images/choices/${computerSelection}.png`;
        computerChoiceE1.classList.add("shoot");
...
function animateFirstChar(msg) {
    if (msg !== '') {
        let charE1 = document.createElement("span");
        charE1.textContent = msg[0];
        textBox.appendChild(charE1);
